# ⛓️🔗⛓️ Template for speedy 

## 📚 Documentation

There's some basic information here in the README but a more comprehensive documentation can be found in 
...
to install the (https://github.com/speedywall/speedy.git) as a dependency.
...
Check if the packet got through on the [speedy maintenance].
...
You can use the contracts in the "/contracts/base" directory as base contracts for creating speedy enabled contracts that can either send packets over the universal channel or create their own channel to send packets over.

A complete walkthrough on how to develop these contracts is provided in the [speedy under maintenance]
...
Feel free to open an issue for questions, suggestions, or discussions related to this repository. For further discussion as well as a showcase of some community projects, check out the .[https://discord.gg/ZQ5wr9Qu]

Thank you for being a part of our community!

speedy machatea product
